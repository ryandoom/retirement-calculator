class RetirementProjectionsController < ApplicationController
  def new
    @retirement_projection = RetirementProjection.new({
      ...
      expected_percentage_increase_in_income_yearly: 0.05,
      current_annual_expenditures: 30000,
      expected_percentage_increase_in_expenditures: 0.03,
      planned_retirement_age: 55,
      age_at_death: 95,
      expected_income_once_retired: 10000,
      expected_present_day_expenses_when_retired: 20000,
